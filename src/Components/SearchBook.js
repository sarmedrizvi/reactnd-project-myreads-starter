        ...
        <div className="search-books-bar">
          ...
          <div className="search-books-input-wrapper">
            {/*
                ...
                */}
            <input type="text" placeholder="Search by title or author" onChange={TextChangeEvent} value={this.state.searchValue} />
          </div>
        </div>
        <div className="search-books-results">
          <ol className="books-grid">
            {this.state.searchBooks.length !== 0 ? this.state.searchBooks.map(
                (book) => {
                  return (
                    <li key={book.id}>
                      <div className="book">
